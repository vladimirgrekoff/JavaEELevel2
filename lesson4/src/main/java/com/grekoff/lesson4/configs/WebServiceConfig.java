...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    // http://localhost:8189/lesson4/ws/categories.wsdl
    ...
    public DefaultWsdl11Definition categoriesWsdl11Definition(XsdSchema categoriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.grekoff.com/lesson4/categories");
        wsdl11Definition.setSchema(categoriesSchema);
        return wsdl11Definition;
    }

    // http://localhost:8189/lesson4/ws/products.wsdl
    @Bean(name = "products")
    public DefaultWsdl11Definition productsWsdl11Definition(XsdSchema productsSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("ProductsPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.grekoff.com/lesson4/products");
